...
class TestView(TestCase):
    def setUp(self):
        ...
        self.category_programming = Category.objects.create(name='programing', slug='programing')
    ...
    def test_create_post(self):
        # status code isn't 200 without log-in
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)

        # trump who isn't a staff logs-in
        self.client.login(username='trump', password='somepassword')
        response = self.client.get('/blog/create_post/')
        self.assertNotEqual(response.status_code, 200)

        # obama who is a staff logs-in
    ...
    def test_update_post(self):
        ...
        # who's not the author logged-in
